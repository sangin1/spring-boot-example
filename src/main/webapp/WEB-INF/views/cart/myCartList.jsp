...
<body>
               ...
               <form name="frm_order_all_cart">
					...
					<td>
					   <input type="text" id="cart_goods_qty" name="cart_goods_qty" size=3 value="${cart_goods_qty}"><br>
						<a href="javascript:modify_cart_qty(${item.goods_id },${item.goods_sales_price*0.9 },${cnt.count-1 });" >
						    <img width=25 alt=""  src="/image/btn_modify_qty.jpg">
						</a>
					</td>
					<td>
					   <strong>
					...
					<td>
					      <a href="javascript:fn_order_each_goods('${item.goods_id }','${item.goods_title }','${item.goods_sales_price}','${item.goods_fileName}');">
					       	<img width="75" alt=""  src="/image/btn_order.jpg">
							</a><br>
					 	<a href="#"> 
					 	   <img width="75" alt=""
							src="/image/btn_order_later.jpg">
						</a><br> 
						<a href="#"> 
						   <img width="75" alt=""
							src="/image/btn_add_list.jpg">
						</A><br> 
						<a href="javascript:delete_cart_goods('${cart_id}');""> 
						   <img width="75" alt=""
							   src="/image/btn_delete.jpg">
					   </a>
					</td>
			</tr>
	...
	<tbody>
		...
		<tr cellpadding=40  align=center >
	       ...
	       <td> 
	         <img width="25" alt="" src="/image/minus.jpg"> 
	       </td>
	       <td>  
    ...
    <br><br>	
		 <a href="javascript:fn_order_all_cart_goods()">
		 	<img width="75" alt="" src="/image/btn_order_final.jpg">
		 </a>
		 <a href="#">
